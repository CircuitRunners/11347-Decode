...
@Config
@Configurable
@Autonomous(name="Blue Side Auto Close 12",group="Blue Autos", preselectTeleOp="MainTeleOp")
public class BlueSideClose12 extends OpMode {
...
//three changes 9----four changes 12
        line1 = follower
                .pathBuilder()
                .addPath(
