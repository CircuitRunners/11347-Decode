...
@Config
@Configurable
@Autonomous(name="Blue Side Auto 67",group="Blue Autos", preselectTeleOp="MainTeleOp")
public class sixtysevenBallAuto extends OpMode {
    ...
    public void buildPaths() {
        ...
        line1 = follower
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(50.000, 18.000),
                                new Pose(72.000, 20.000)
                        )
                )
        ...
        line2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(72.000, 20.000), new Pose(41.000, 35.000))
                )
        ...
        line4 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(8.000, 35.000), new Pose(72.000, 20.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(270))
                .build();
        ...
        line5 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(72.000, 20.000), new Pose(41.000, 59.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(180))
                .build();
        ...
        line6 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(41.000, 59.000), new Pose(8.000, 59.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        line7 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(8.000, 59.000), new Pose(72.000, 20.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(270))
                .build();
        ...
        line8 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(72.000, 20.000), new Pose(41.000, 84.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(180))
                .build();
        ...
        line9 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(41.000, 84.000), new Pose(14.800, 84.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        line10 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(14.800, 84.000), new Pose(72.000, 20.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(270))
                .build();
    }
